...
public class GwtRendererQualifierProcessor extends AbstractQualifierProcessorExtension {
    ...
    public void processPropertyQualifier(final JavaWriter writer, String beanName, String propertyName,
        ...
        context.doIfExists(String.class, REPRESENTER_TEXT_RENDERER, resourceMethod(writer, type, "Renderer"));
        context.doIfExists(String.class, REPRESENTER_HTML_RENDERER, resourceMethod(writer, type, "SafeHtmlRenderer"));
    }
